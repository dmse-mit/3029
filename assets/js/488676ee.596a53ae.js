"use strict";(self.webpackChunkwebsite=self.webpackChunkwebsite||[]).push([[449],{1152:function(e,t,n){n.d(t,{Z:function(){return h}});var a=n(5861),r=n(7757),i=n.n(r),o=n(7294),l=n(9483),c=n(9669),s=n.n(c),u=n(1721),d=n(2118),m=n(6214),f=n(4639),p=function(){var e=(0,a.Z)(i().mark((function e(t){var n,a,r,o,l,c,u,d,m;return i().wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=new RegExp(/https:\/\/github.com\/(.+?)\/(.+?)\/blob\/(.+?)\/(.+\.ipynb)/),a=t.match(n),r=a[1],o=a[2],l=a[3],c=a[4],u="https://api.github.com/repos/"+r+"/"+o+"/contents/"+c+"?ref="+l,e.next=6,s().get(u);case 6:return e.next=8,e.sent.data;case 8:return d=e.sent,i=JSON.parse((g=d.content,decodeURIComponent(atob(g).split("").map((function(e){return"%"+("00"+e.charCodeAt(0).toString(16)).slice(-2)})).join("")))),f=void 0,p=void 0,f=i.metadata,p="Wolfram Language"==f.kernelspec.language?"mathematica":f.kernelspec.language,f.kernelspec.language=p,m={cells:i.cells.map((function(e){if("markdown"==e.cell_type){var t=e.source.join("").trim().replace(/(\${1,2})((?:\\.|[\s\S])*?)\1/g,(function(e,t,n){return t+n.replace(/\r?\n/g,"")+t}));return{cell_type:e.cell_type,id:e.id,metadata:e.metadata,source:t.split(/(\r\n|\n|\r)/)}}return e})),metadata:f,nbformat:i.nbformat,nbformat_minor:i.nbformat_minor},console.log(m),e.abrupt("return",m);case 12:case"end":return e.stop()}var i,f,p,g}),e)})));return function(t){return e.apply(this,arguments)}}(),g=function(e){return o.createElement(u.D,{remarkPlugins:[d.Z],rehypePlugins:[m.Z],children:e.source})};function h(e){var t=e.notebookURL,n=o.useState(null),a=n[0],r=n[1];return o.useEffect((function(){p(t).then(r)}),[t]),o.createElement("div",{className:"NotebookViewer"},null===a?"Loading notebook...":o.createElement(l.Z,{source:a,code:f.Z,markdown:g}))}},2790:function(e,t,n){var a=n(5068),r=n(7294),i=n(1146),o=function(e){function t(){return e.apply(this,arguments)||this}(0,a.Z)(t,e);var n=t.prototype;return n.componentDidMount=function(){this.embedding=(0,i.embed)(this.props.url,this.el,{allowInteract:!0,showRenderProgress:!0})},n.componentWillUnmount=function(){this.embedding.then((function(e){return e.detach()}))},n.render=function(){var e=this;return r.createElement("div",{className:"NotebookEmbed",ref:function(t){return e.el=t}})},t}(r.Component);t.Z=o},5622:function(e,t,n){n.r(t),n.d(t,{contentTitle:function(){return g},default:function(){return b},frontMatter:function(){return p},metadata:function(){return h},toc:function(){return v}});var a=n(7462),r=n(3366),i=n(7294),o=n(3905),l=(n(2790),n(1152),n(2543));function c(e,t){const n=e.module();return n.variable(t()).define(["md"],(function(e){return e`# Color Legend
...
.${u}-swatch {
  ...
  <div style=${{width:"100%",columns:a}}>${f.map((e=>{const a=`${r(e)}`;return t.html`<div class=${u}-item>
...
.${u}::before {
  ...
  <div>${f.map((e=>t.html`<span class="${u}" style="--color: ${n(e)}">${r(e)}</span>`))}</div>`}})),n.variable(t("swatches")).define("swatches",["Swatches"],(function(e){return function({color:t,...n}){return e(t,n)}})),n}function s(e,t){const n=e.module();n.variable(t()).define(["md"],(function(e){return e`# Molecular Dynamics - 3.001 Demo
