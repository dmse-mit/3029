"use strict";(self.webpackChunkwebsite=self.webpackChunkwebsite||[]).push([[8449],{5622:function(e,t,n){n.r(t),n.d(t,{assets:function(){return v},contentTitle:function(){return g},default:function(){return _},frontMatter:function(){return p},metadata:function(){return h},toc:function(){return y}});var a=n(3117),r=n(102),i=n(7294),o=n(3905),l=(n(2790),n(7274),n(2543));function c(e,t){const n=e.module();return n.variable(t()).define(["md"],(function(e){return e`# Color Legend
...
## Implementation`})),n.variable(t("Legend")).define("Legend",["d3"],(function(e){return function(t,{title:n,tickSize:a=6,width:r=320,height:i=44+a,marginTop:o=18,marginRight:l=0,marginBottom:c=16+a,marginLeft:s=0,ticks:d=r/64,tickFormat:u,tickValues:f}={}){function m(e,t=256){const n=document.createElement("canvas");n.width=t,n.height=1;const a=n.getContext("2d");for(let r=0;r<t;++r)a.fillStyle=e(r/(t-1)),a.fillRect(r,0,1,1);return n}const p=e.create("svg").attr("width",r).attr("height",i).attr("viewBox",[0,0,r,i]).style("overflow","visible").style("display","block");let g,h=e=>e.selectAll(".tick line").attr("y1",o+c-i);if(t.interpolate){const n=Math.min(t.domain().length,t.range().length);g=t.copy().rangeRound(e.quantize(e.interpolate(s,r-l),n)),p.append("image").attr("x",s).attr("y",o).attr("width",r-s-l).attr("height",i-o-c).attr("preserveAspectRatio","none").attr("xlink:href",m(t.copy().domain(e.quantize(e.interpolate(0,1),n))).toDataURL())}else if(t.interpolator){if(g=Object.assign(t.copy().interpolator(e.interpolateRound(s,r-l)),{range:()=>[s,r-l]}),p.append("image").attr("x",s).attr("y",o).attr("width",r-s-l).attr("height",i-o-c).attr("preserveAspectRatio","none").attr("xlink:href",m(t.interpolator()).toDataURL()),!g.ticks){if(void 0===f){const n=Math.round(d+1);f=e.range(n).map((a=>e.quantile(t.domain(),a/(n-1))))}"function"!=typeof u&&(u=e.format(void 0===u?",f":u))}}else if(t.invertExtent){const n=t.thresholds?t.thresholds():t.quantiles?t.quantiles():t.domain(),a=void 0===u?e=>e:"string"==typeof u?e.format(u):u;g=e.scaleLinear().domain([-1,t.range().length-1]).rangeRound([s,r-l]),p.append("g").selectAll("rect").data(t.range()).join("rect").attr("x",((e,t)=>g(t-1))).attr("y",o).attr("width",((e,t)=>g(t)-g(t-1))).attr("height",i-o-c).attr("fill",(e=>e)),f=e.range(n.length),u=e=>a(n[e],e)}else g=e.scaleBand().domain(t.domain()).rangeRound([s,r-l]),p.append("g").selectAll("rect").data(t.domain()).join("rect").attr("x",g).attr("y",o).attr("width",Math.max(0,g.bandwidth()-1)).attr("height",i-o-c).attr("fill",t),h=()=>{};return p.append("g").attr("transform",`translate(0,${i-c})`).call(e.axisBottom(g).ticks(d,"string"==typeof u?u:void 0).tickFormat("function"==typeof u?u:void 0).tickSize(a).tickValues(f)).call(h).call((e=>e.select(".domain").remove())).call((e=>e.append("text").attr("x",s).attr("y",o+c-i-6).attr("fill","currentColor").attr("text-anchor","start").attr("font-weight","bold").attr("class","title").text(n))),p.node()}})),n.variable(t("legend")).define("legend",["Legend"],(function(e){return function({color:t,...n}){return e(t,n)}})),n.variable(t("Swatches")).define("Swatches",["d3","htl"],(function(e,t){return function(n,{columns:a=null,format:r,unknown:i,swatchSize:o=15,swatchWidth:l=o,swatchHeight:c=o,marginLeft:s=0}={}){const d=`-swatches-${Math.random().toString(16).slice(2)}`,u=null==i?void 0:n.unknown(),f=null==u||u===e.scaleImplicit?[]:[u],m=n.domain().concat(f);return void 0===r&&(r=e=>e===u?i:e),null!==a?t.html`<div style="display: flex; align-items: center; margin-left: ${+s}px; min-height: 33px; font: 10px sans-serif;">
  <style>
...
.${d}-swatch {
  ...
  <div style=${{width:"100%",columns:a}}>${m.map((e=>{const a=`${r(e)}`;return t.html`<div class=${d}-item>
...
.${d}::before {
  ...
  <div>${m.map((e=>t.html`<span class="${d}" style="--color: ${n(e)}">${r(e)}</span>`))}</div>`}})),n.variable(t("swatches")).define("swatches",["Swatches"],(function(e){return function({color:t,...n}){return e(t,n)}})),n}function s(e,t){const n=e.module();n.variable(t()).define(["md"],(function(e){return e`# Molecular Dynamics - 3.001 Demo
